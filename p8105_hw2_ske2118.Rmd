...
`r sum(pull(filter(trash_wheel_tidy, wheel == "gwynnda_wheel"), cigarette_butts), na.rm = TRUE) ` cigarette butts.
...
Using janitor::clean_names() to clean all the column names. We notice that in each of the four datasets
there is series so we can join by that variable 
